...
const eventItems = [
  ["2026년 5월 나트랑 달밤 1:1 이벤트", "2026.04.29"],
  ["2025년 12월 나트랑 달밤 정모 안내", "2025.11.20"],
  ["2025년 11월 나트랑 달밤 정모 안내", "2025.10.23"],
  ["2025년 10월 나트랑 달밤 이벤트", "2025.09.17"],
  ["2025년 9월 달밤 정모 안내", "2025.08.22"],
  ["[달밤 궁상] 나트랑 프라이빗 파티", "2025.04.16"],
] as const;
const serviceItems = [
