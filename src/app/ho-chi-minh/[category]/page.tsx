...
const eventItems = [
  ["2026년 5월 호치민 달밤 1:1 이벤트", "2026.04.29"], ["2025년 12월 호치민 달밤 정모 안내", "2025.11.20"],
  ["2025년 11월 호치민 달밤 정모 안내", "2025.10.23"], ["2025년 10월 달밤 이벤트", "2025.09.17"],
  ["2025년 9월 달밤 정모 안내", "2025.08.22"], ["[달밤 궁상] 호치민 프라이빗 파티", "2025.04.16"],
] as const;
const serviceItems = [
  ["달밤 호치민 VIP 패스트트랙", "2024.06.28"], ["달밤 나트랑 VIP 패스트트랙", "2024.07.02"],
  ["달밤 하노이 VIP 패스트트랙", "2024.08.07"], ["달밤 다낭 VIP 패스트트랙", "2024.06.29"],
] as const;
...
export default async function CategoryPage({ params, searchParams }: { params: Promise<{ category: string }>; searchParams: Promise<{ page?: string; area?: string; subject?: string; q?: string }> }) {
  ...
  return <main className="min-h-screen overflow-x-hidden bg-[#f3f1ec]">
      ...
      <div className="mx-auto max-w-[1740px]">
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <div className="hidden h-fit rounded-2xl bg-card p-3 shadow-[0_10px_30px_rgba(30,26,20,.08)] lg:block">
            <div className="overflow-hidden rounded-xl"><a href="https://t.me/+A3VGGGBdkFllYWE9" target="_blank" rel="noreferrer" className="block aspect-[2268/720] overflow-hidden"><img src="/vietdalbam/upload/0e4942bd4a4e4ac699bd991fe4133439.webp" alt="달밤 텔레방" className="h-full w-full object-cover"/></a><a href="https://open.kakao.com/o/gziI3pyh" target="_blank" rel="noreferrer" className="block aspect-[2268/720] overflow-hidden"><img src="/vietdalbam/upload/f5d0a13573ff441e95560ae9955acfd7.webp" alt="달밤 단톡방" className="h-full w-full object-cover"/></a></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="px-6 pb-12 lg:hidden"><div className="mx-auto max-w-[340px] rounded-2xl bg-card p-3 shadow-[0_10px_30px_rgba(30,26,20,.08)]"><a href="https://t.me/+A3VGGGBdkFllYWE9" target="_blank" rel="noreferrer" className="block aspect-[2268/720] overflow-hidden"><img src="/vietdalbam/upload/0e4942bd4a4e4ac699bd991fe4133439.webp" alt="달밤 텔레방" className="h-full w-full object-cover"/></a><a href="https://open.kakao.com/o/gziI3pyh" target="_blank" rel="noreferrer" className="block aspect-[2268/720] overflow-hidden"><img src="/vietdalbam/upload/f5d0a13573ff441e95560ae9955acfd7.webp" alt="달밤 단톡방" className="h-full w-full object-cover"/></a></div></section>
    <Footer />
  </main>;
}
