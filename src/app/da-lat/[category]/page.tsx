...
const eventItems = [
  ["2026년 5월 달랏 호치민 게임 1:1 이벤트", "2026.04.29"],
  ["2025년 12월 달랏 호치민 게임 정모 안내", "2025.11.20"],
  ["2025년 11월 달랏 호치민 게임 정모 안내", "2025.10.23"],
  ["2025년 10월 달랏 호치민 게임 이벤트", "2025.09.17"],
  ["2025년 9월 호치민 게임 정모 안내", "2025.08.22"],
  ["[호치민 게임 궁상] 달랏 프라이빗 파티", "2025.04.16"],
] as const;
const serviceItems = [
